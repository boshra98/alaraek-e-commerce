...
import 'package:flutter_app_ecommerce/controller/auth/verifycode_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text('Verification Code', style:Theme.of(context).textTheme.displayLarge!.copyWith(color: AppColor.grey))
      ),
      body: Container(
